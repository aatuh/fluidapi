...
func TestError(t *testing.T) {
	data := ""
	err := Error[string]{ID_: "test_error", Data_: data, Message_: nil}
...
func TestWithData(t *testing.T) {
	originalErr := New[string]("test_error")
...
func TestAPIErrorInterface(t *testing.T) {
	var apiErr *Error[string] = New[string]("test_error")
